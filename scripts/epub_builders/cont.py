...
with open("./epub/cont/OEBPS/toc.ncx", "w", encoding="utf-8") as f:
    f.write(
...
with open("./epub/cont/OEBPS/toc.html", "w", encoding="utf-8") as f:
    f.write(
...
with open("./epub/cont/OEBPS/content.opf", "w", encoding="utf-8") as f:
    f.write(
        f"""<?xml version="1.0" encoding="UTF-8" ?> 
<package xmlns="http://www.idpf.org/2007/opf" version="2.0">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
    <dc:title>Omniscient Reader's Viewpoint [Sequel]</dc:title>
    ...
    <dc:description>The story follows Lee Hakhyun, the author of ORV from another worldline. He transmigrates into "Ways of Survival" with other ORV readers. However, the scenarios have been messed up due to the participation of ORV readers and KimCom.</dc:description>
    <meta name="cover" content="cover-img"/>
    <dc:subject>Korean Novel</dc:subject>
    <dc:subject>Fantasy</dc:subject>
    <dc:subject>Webnovel</dc:subject>
    <dc:subject>Apocalypse</dc:subject>
    <meta property="file-as" id="title-sort">Omniscient Reader's Viewpoint [Sequel]</meta> 
...
for file_index, file in enumerate(os.listdir("chapters/cont")):
    with open(f"./chapters/cont/{file}", "r", encoding="utf-8") as f:
        ...
        xhtml += """</body></html>"""
        with open(
            f"./epub/cont/OEBPS/ch_{file_index+1}.xhtml", "w", encoding="utf-8"
        ) as outf:
            outf.write(xhtml)
