...
with open("./epub/orv/OEBPS/toc.ncx", "w", encoding="utf-8") as f:
    f.write(
...
with open("./epub/orv/OEBPS/toc.html", "w", encoding="utf-8") as f:
    f.write(
...
with open("./epub/orv/OEBPS/content.opf", "w", encoding="utf-8") as f:
    f.write(
        f"""<?xml version="1.0" encoding="UTF-8" ?> 
<package xmlns="http://www.idpf.org/2007/opf" version="2.0">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:opf="http://www.idpf.org/2007/opf">
    <dc:title>Omniscient Reader's Viewpoint [Main Story]</dc:title>
    ...
    <dc:description>Only I know the end of this world. One day our MC finds himself stuck in the world of his favorite webnovel. What does he do to survive? It is a world struck by catastrophe and danger all around. His edge? He knows the plot of the story to end. Because he was the sole reader that stuck with it. Read his story to see how he survives!</dc:description>
    <meta name="cover" content="cover-img"/>
    <dc:subject>Korean Novel</dc:subject>
    <dc:subject>Fantasy</dc:subject>
    <dc:subject>Webnovel</dc:subject>
    <dc:subject>Apocalypse</dc:subject>
    <meta property="file-as" id="title-sort">Omniscient Reader's Viewpoint [Main Story]</meta> 
...
for file_index, file in enumerate(os.listdir("chapters/orv")):
    with open(f"./chapters/orv/{file}", "r", encoding="utf-8") as f:
        ...
        xhtml += """</body></html>"""
        with open(
            f"./epub/orv/OEBPS/ch_{file_index+1}.xhtml", "w", encoding="utf-8"
        ) as outf:
            outf.write(xhtml)
